...
class TargetPolicy
{
    ...
    public function view(User $user, Target $model): Response
    {
    ...
    public function update(User $user, Target $model): Response
    {
    ...
    public function delete(User $user, Target $model): Response
    {
