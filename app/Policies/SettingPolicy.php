...
class SettingPolicy
{
    ...
    public function view(User $user, Setting $model): Response
    {
    ...
    public function update(User $user, Setting $model): Response
    {
    ...
    public function delete(User $user, Setting $model): Response
    {
