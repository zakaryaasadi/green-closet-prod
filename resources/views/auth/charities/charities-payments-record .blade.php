            ...
            <div class="col-10 pt-3">
                <div class="container table-responsive order-container d-flex flex-column">
                    ...
                    <div
                        ...
                        @include('auth.charities.payments-record-table')
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetch_data(page) {
                $.ajax({
                    url:  `/{{\App\Helpers\AppHelper::getSlug()}}/association/expenses-association/pagination?page=${page}}`  ,
