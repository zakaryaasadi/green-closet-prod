            ...
            <div class="col-10 pt-3">
                <div class="container table-responsive order-container d-flex flex-column">
                        ...
                        <div class=" w-100">
                            <div class="row">
                                <div class="col-12 d-flex">
                                    <h3 class="text-bold ">{{__('Containers Details Report')}}</h3>
                    ...
                    <div
                        ...
                        id="table_data">
                        @include('auth.charities.charity-containers-details-table')
                    </div>
                </div>
            </div>
        </div>
        ...
        $(document).ready(function () {
            ...
            function fetch_data(page,data) {
                ...
                $.ajax({
                    type: 'POST',
                    data : data,
                    url: `/{{\App\Helpers\AppHelper::getSlug()}}/association/containers-details/pagination?page=${page}`,
            ...
            $(document).on('click', '#filter', function (event) {
                ...
                $.ajax({
                    type: 'POST',
                    data : data,
                    url: `/{{\App\Helpers\AppHelper::getSlug()}}/association/containers-details/pagination`,
                    success: function (orders) {
                        $('#table_data').html(orders);
                    }
                });
