            ...
            <div class="col-10 pt-3">
                <div class="container table-responsive order-container d-flex flex-column">
                        ...
                        <div class=" w-100">
                            <div class="row">
                                <div class="col-12 d-flex">
                                    <h3 class="text-bold ">{{__('Orders List')}}</h3>
                                                        ...
                                                        <div class="container">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-12 col-md-6 col-lg-4 mt-2 mt-md-1 d-flex align-items-center gap-1">
                                                                    ...
                                                                    <select id="select_id" class="form-select select-filter-orders"
                                                                            name="filter">
                                                                        <option value="All">{{__('All')}}</option>
                                                                        <option value="1">{{__('Created')}}</option>
                                                                        <option value="2">{{__('Assigned')}}</option>
                                                                        <option value="3">{{__('Accepted')}}</option>
                                                                        <option value="4">{{__('Declined')}}</option>
                                                                        <option value="5">{{__('Canceled')}}</option>
                                                                        <option value="6">{{__('Delivering')}}</option>
                                                                        <option value="7">{{__('Failed')}}</option>
                                                                        <option value="8">{{__('Successful')}}</option>
                                                                        <option value="9">{{__('Postponed')}}</option>
                                                                    </select>
                                                                </div>
                    ...
                    <div
                        ...
                        id="table_data">
                        @include('auth.components.orders-charity-table')
                    </div>
                </div>
            </div>
        </div>
        ...
        $(document).ready(function () {
            ...
            function fetch_data(page,data) {
                ...
                $.ajax({
                    type: 'POST',
                    data : data,
                    url: `/{{\App\Helpers\AppHelper::getSlug()}}/association/orders-association/pagination?page=${page}`,
            ...
            $(document).on('click', '#filter', function (event) {
                ...
                $.ajax({
                    type: 'POST',
                    data : data,
                    url: `/{{\App\Helpers\AppHelper::getSlug()}}/association/orders-association/pagination`,
                    success: function (orders) {
                        $('#table_data').html(orders);
                    }
                });
