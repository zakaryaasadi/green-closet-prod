...
<section class="news-page my-5 position-relative ">
    <div class="container">
        <div class="row">
            <div class="col-12 d-flex align-items-center justify-content-center mb-4 flex-column">
                <h1>{!!$section['title']??""!!}</h1>
                <div class="my-1"
                     data-aos="fade-down">{!! isset($section['description']) ?  $section['description'] : ""!!}</div>
        ...
        <div class="w-100">
            @foreach($news as $item)
                <a href="/{{AppHelper::getSlug()}}/news/{{$item['slug']}}"
                   class="text-dark text-decoration-none d-flex row ">
