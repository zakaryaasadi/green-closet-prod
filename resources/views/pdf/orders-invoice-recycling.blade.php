...
<table class="table-content" style="width: 100%; margin-top: .1cm;">
    ...
    <tr class="table-head" style=" ">
        <td style="padding: .2cm;font-weight: bold;">Invoice</td>
        <td style="padding: .2cm;font-weight: bold"></td>
        <td style="padding: .2cm;font-weight: bold"></td>
        <td style="text-align: right ;padding: .2cm;font-weight: bold;">فاتورة</td>
    </tr>
    ...
    <tr style="  ">
        <td style="padding: .2cm;">
            <span>Invoice No :</span> <span>{{$invoice->id}}</span>
        ...
        <td style="text-align: right ;padding: .2cm;">رقم الفاتورة</td>
    </tr>
    <tr style="  ">
        <td style="padding: .2cm;">
            <span>Invoice Date :</span> <span>{{$invoice->created_at}}</span>
        </td>
        <td style="padding: .2cm;text-align: start">
    ...
    <tr class="table-head" style="margin-top: 0cm ">
        <td style="padding: .2cm;padding-bottom: 0;font-weight: bold;">CLIENT INFORMATION</td>
    ...
    <tr class="table-head" style="margin-top: 0cm;padding-top: 0 ">
        <td style="padding: .2cm;padding-top: 0;font-weight: bold;">معلومات العميل</td>
        <td style="padding: .2cm;padding-top: 0;font-weight: bold"></td>
        <td style="padding: .2cm;padding-top: 0;font-weight: bold;"></td>
...
<table class="main-table" style="margin-top: .5cm;width: 100%">
    <tr class="bg-black">
        ...
        <td style="padding: .2cm">
            ...
            <span class="block w-100 fl- " style="text-align: start;float: left">Price Per KG</span>
            <br>
            <span class="block w-100 fl- " style="text-align: start;float: left">السعر لكل كيلو غرام</span>

        </td>
        <td style="padding: .2cm">

            <span class="block w-100 fl- " style="text-align: start;float: left">Total Price</span>
            <br>
            <span class="block w-100 fl- " style="text-align: start;float: left">السعر الأجمالي</span>
    ...
    @foreach($order->items as $item)
        @if($item->pivot->weight>0)
            <tr>
                ...
                <td style="padding: .2cm">{{$item->price_per_kg . ' ' . $currency_en . ' / ' .  $currency_ar}}
                </td>
                <td style="padding: .2cm">{{$item->pivot->weight * $item->price_per_kg  . ' ' . $currency_en . ' / ' .  $currency_ar}}
                </td>
            </tr>
        @endif
    ...
    <tr>
        <td style="padding: .2cm" class="border-0"></td>
        <td style="padding: .2cm" class="border-0"></td>
        <td style="padding: .2cm" class="border-0"></td>
        <td style="padding: .2cm" class="bg-black">{{$order->value . ' ' . $currency_en . ' / ' .  $currency_ar}}</td>
    </tr>
</table>
